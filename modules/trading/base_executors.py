    ...
    async def _wait_for_confirmation(
        ...
        *,
        ...
        while loop.time() < deadline:
            try:
                status = await self._fetch_signature_status(
                    tx_signature=tx_signature,
            ...
            if last_valid_block_height is not None and loop.time() >= next_block_height_check:
                ...
                next_block_height_check = loop.time() + max(self._confirm_poll_interval_seconds, 0.4)
    ...
    async def _fetch_signature_status(
        ...
        *,
        ...
        result = await self._rpc_call(
            ...
            [[tx_signature], {"searchTransactionHistory": bool(search_transaction_history)}],
        )
